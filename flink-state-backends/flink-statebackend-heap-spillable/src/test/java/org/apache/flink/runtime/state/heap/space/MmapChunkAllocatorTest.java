...
public class MmapChunkAllocatorTest {
	...
	@Test
	public void testCandidateDirectoryInvalid() throws Exception {
		// test some directories are invalid
	}

	@Test
	public void testSpacePreallocated() throws Exception {
		// test disk space is pre-allocated
	}
}
